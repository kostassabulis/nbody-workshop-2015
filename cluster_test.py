...
bodies.color = np.zeros_like(bodies.m, dtype='|S1')
...
snapshot_renderer = SnapshotRenderer.for_clusters(snapshot_storage, bounds=[-2e14, 2e14], verbose=1, colour=bodies.color, angle=[45, 45])
